...
public class testSquadron {
    ...
    {   
        ...
        // var squadronCircleFormation = circleSquad.CreateEnemies(enemyStridesBlue, enemyStridesRed, 0.00f);
        // var squadronWaveFormation = waveSquad.CreateEnemies(enemyStridesBlue, enemyStridesRed, 0.00f);
